...
module Spree
  module Auth
    class Engine < Rails::Engine
      ...
      engine_name 'open_auth'

      initializer "spree.auth.environment", before: :load_config_initializers do |_app|
        Spree::Auth::Config = Spree::AuthConfiguration.new
      end

      initializer "open_auth_devise.set_user_class", after: :load_config_initializers do
      ...
      config.to_prepare do
        ...
        auth.prepare_backend  if backend_available?
        auth.prepare_frontend if frontend_available?
